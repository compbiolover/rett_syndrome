...
for (s in unique(all_plot_data$subregion)) {
  ...
  p1 <- Heatmap(matrix = lower_estimates, show_heatmap_legend = TRUE,
                heatmap_legend_param = list(title = "Delta Means (x-y)",
                ...
                na_col = "white", column_names_gp = gpar(fontsize = 16,
                                                         fontface = "bold"), 
                column_title = paste0(s, " | Mean 2"), 
  ...
  png(file = paste0("Outputs/pnn_analysis/heatmaps/subregion_", s, "_complex_heatmap_mean2.png"), units = "in", width = 6, height = 0.3937 * 6 + 0.7423, res = 600)
...
save_plot(filename = "Outputs/pnn_analysis/heatmaps/combo_plot_complexheatmap_mean2.png", plot = combo_plot, ncol = 5, nrow = 5, base_asp = 1.0, bg = "white")
```
