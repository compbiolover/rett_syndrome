...
if (gmm_n == 2 & chs_rm == "n" & using_mean1 == FALSE) {
  for (s in unique(icc_df$subregion)) {
    ...
    ggsave(
      plot = print(heatmap), filename = paste0("Outputs/pnn_analysis/heatmaps/two_cluster_gmm/mean_2/no_chs_removed/", s, "_mean_2.png"),
...
ggsave(path = "Outputs/pnn_analysis/heatmaps/two_cluster_gmm/mean_1/no_chs_removed/", filename = "mean_1_combo_plot_groups_split.png", plot = annotated_figure, device = "png", width = 20, height = 20, units = "in", dpi = 600, bg = "white")
```
