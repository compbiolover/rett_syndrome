...
p2 <- ggpar(p1,
  ...
  main = paste0("KNN = ", k_n," | All Conditions & Images | Spearman"),
  font.main = c(16, "bold"),
  font.x = c(14, "bold"),
  font.y = c(14, "bold")
)
...
for (c in unique(mean_neighbor_df$condition_spec)) {
  ...
  ggsave(plot = p3, filename = paste0("knn_", k_n,"_", c, "_positive_neighborhood_correlation_analysis.png"), path = "Outputs/knn_analysis/plots/correlation_analysis/", device = "png", dpi = 600, width = 8, height = 8, units = "in")
  
  plots[[paste0(c)]] <- p3
}

# Combo plot
combo_plot <- ggarrange(plotlist = plots,
                        ncol = 2,
                        nrow = 2,
                        labels = "AUTO",
                        align = "hv",
...
ggsave(plot = combo_plot, filename = paste0("knn_",k_n,"_combo_plot_neighborhood_correlation_analysis.png"), path = "Outputs/knn_analysis/plots/correlation_analysis/", device = "png", dpi = 600, width = 16, height = 16, units = "in", bg = "white")
