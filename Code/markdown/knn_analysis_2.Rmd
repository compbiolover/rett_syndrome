...
p1 <- ggplot(data = knn_3_df, aes(x = condition_spec, y = knn_3_label, fill = mecp2_p)) +
  ...
  ylab("3NN score ") +
  scale_fill_manual(values = c("#4682b4", "#F4A460"), name = "MECP2\nStatus") +
  geom_signif(y_position = c(4.0, 4.0, 4.0, 4.0), xmin = c(0.8, 1.8, 2.8, 3.8), xmax = c(1.2, 2.2, 3.2, 4.2), annotations = c("ns", "ns", "**", "ns"))
...
p2 <- ggplot(data = knn_5_df, aes(x = condition_spec, y = knn_5_label, fill = mecp2_p)) +
  ...
  ylab("5NN score ") +
  scale_fill_manual(values = c("#4682b4", "#F4A460"), name = "MECP2\nStatus") +
  geom_signif(y_position = c(5.5, 5.5, 5.5, 5.5), xmin = c(0.8, 1.8, 2.8, 3.8), xmax = c(1.2, 2.2, 3.2, 4.2), annotations = c("ns", "ns", "ns", "ns"))
...
```{r saving combo plot}
ggsave(
  plot = combo_plot, filename = "knn_combo_plot.png", device = "png", width = 10,
