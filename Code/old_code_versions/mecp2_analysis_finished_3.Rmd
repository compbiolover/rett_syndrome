...
```{r}
mecp2_data_processed_12wk <- merge(mecp2_data_processed_12wk, mecp2_intensity_12wk)
```


Modifying workflow to be in line with Logan's
```{r}
# mecp2_data_processed_12wk <- filter(mecp2_data_processed_12wk,
#                                     Condition=="NH" | Condition=="NW")
# 
# mecp2_data_processed_12wk_non <- filter(mecp2_data_processed_12wk, Cell_type=="PNN-neg") 
# 
# mecp2_intensity_12wk_non <- 
...
```{r}
mecp2_data_processed_12wk_pos <- filter(mecp2_data_processed_12wk, Cell_type=="PNN-pos") 
```
