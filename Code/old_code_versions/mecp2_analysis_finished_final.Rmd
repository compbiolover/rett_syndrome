...
```{r loading-data, tidy=TRUE, tidy.opts=list(arrow=TRUE, indent=2), echo=FALSE, results='hide', warning=FALSE}
#Loading the data
setwd("~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Data")


mecp2_data <- read.csv("~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Data/mecp2_raw_histogram_data_excluded_values_removed.csv")
...
```{r 6-week-gmm, message=FALSE, fig.show='hide', echo=FALSE, warning=FALSE}
...
```{r 12-week-gmm, message=FALSE, fig.show='hide', echo=FALSE, warning=FALSE}
#Doing density estimates for each of the columns of our data frame to get 
...
```{r 6-week-gmm-plots-being-saved, echo=FALSE, message=FALSE}
...
```{r 12-week-gmm-plots-being-saved, echo=FALSE, message=FALSE}
#Plotting the results and saving the mean to do more analysis later
setwd("~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures")
...
```{r adding-means-to-dataframe, echo=FALSE}
...
```{r 6-week-relabeling-conditions, echo=FALSE}
...
```{r 12-week-relabeling-conditions, echo=FALSE}
...
total_plot <- ggplot(aes(x=Combo,y=Mean, fill=Condition), data = mecp2_6_12_pos)+
  geom_violin(draw_quantiles = c(0.25, 0.5, 0.75), fill="white", colour="black")+ theme(panel.background = element_blank(),
...
total_plot <- total_plot + stat_summary(fun=mean, geom="point", shape=21,
                                        size=5, color="#00ff7f", fill="#00ff7f")
...
```{r saving-combo-plot, echo=FALSE}
#Saving the plots
ggsave(filename = "~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures/mecp2_non_and_pv_together.png", device = "png",
       units = "cm", dpi = 300, width = 32, height = 32, plot = combo_plot)
```

```{r saving-non-pv-plot, echo=FALSE}
ggsave(filename = "~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures/mecp2_non_pv.png", device = "png",
       units = "cm", dpi = 300, width = 32, height = 32, plot = total_plot_neg)
```

```{r saving-pv-plot, echo=FALSE}
ggsave(filename = "~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures/mecp2_pv.png", device = "png",
...
```{r saving-lme-plot, echo=FALSE}
#Saving lme plot
ggsave(filename = "~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures/lme_non_pv_plot.png",
...
```{r overall-lme-model-pv-nuclei-plot, echo=FALSE}
total_plot_lme_pv
```


```{r saving-lme-plot-pv, echo=FALSE}
#Saving lme plot
ggsave(filename = "~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Figures/Mecp2_figures/lme_pv_plot.png",
       device = "png", dpi = 300, units = "cm", height = 32,
...
analysis_df <- data.frame(M=round(M_het, digits = 2), Design_effect=round(deff, digits = 2), Effective_size=round(neff, digits = 2))
...
analysis_df_gt
```
Our results show that about 11.43 cohorts is what we would need to get a sample size that would be equivalent to a sample size that had no correlation/clustering. This is about 1.91 times as many cohorts. (e.g. 12 needed instead of the 6 currently done)
