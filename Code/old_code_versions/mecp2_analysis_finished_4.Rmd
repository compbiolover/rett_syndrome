...
>>>>>>> 11cc106bb3e81a2a668452c54c919d0145de6c52
```
...
#Loading the data
setwd("~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Data")
# mecp2_data <- read.csv("histogram_analysis_easy_to_analyze.csv", sep = ",")
# mecp2_data[is.na(mecp2_data)] <- 0
# mecp2_data <- subset(mecp2_data, select=Age:Intensity_chanel_1905)
>>>>>>> 11cc106bb3e81a2a668452c54c919d0145de6c52

mecp2_data <- read.csv("~/Documents/PhD Program/Hong Lab/Projects/Krishnan-lab-Analysis/Data/mecp2_raw_histogram_data.csv")

mecp2_metadata_6wk <- mecp2_data[1:6,1:380]
mecp2_metadata_12wk <- mecp2_data[1:6,381:816]
mecp2_intensity <- mecp2_data[7:2164,2:817]
mecp2_intensity_6wk <- mecp2_intensity[,1:381]
mecp2_intensity_12wk <- mecp2_intensity[,382:816]
...
=======
```{r message=FALSE, fig.show='hide', echo=FALSE, warning=FALSE}
>>>>>>> 11cc106bb3e81a2a668452c54c919d0145de6c52
...
gmm_mod_12wk <- apply(mecp2_intensity_12wk, 1, densityMclust, G = 1,
                      modelNames=c("E", "V"))
```
...
total_plot <- ggplot(aes(x=Combo,y=Mean, fill=Condition), data = mecp2_6_12_pos)+
  geom_violin(draw_quantiles = c(0.25, 0.5, 0.75))+ theme(panel.background = element_blank(),
...
Getting an lme of PV nuclei even though their ICC is low (0.10) and plotting to see if anything changes
```{r, echo=FALSE}
#This is the overall model
...
total_plot <- ggplot(aes(x=Combo, y=Mean, fill=Condition),
  ...
  geom_signif(y_position = c(4300, 3900), xmin = c(1.0,3.0), xmax = c(2.0,4.0),
              annotations = c("*", "ns"), tip_length = 0)+
